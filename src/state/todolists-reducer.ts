...
export const todolistsReducer = (state = initialState, action: GeneralType): Array<TodolistType> => {
    switch (action.type) {
        case "CHANGE-FILTER": {
...
export type GeneralType = changeFilterACType | removeTodolistACType | addTodolistACType | changeTodolistTitleACType;
